...
/*   Updated: 2018/07/03 18:46:25 by maghayev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::increment(int val) {
	if (this->grade + val > 150) throw Bureaucrat::GradeTooHighException();
	this->grade += val;
}
void Bureaucrat::decrement(int val) {
	if (this->grade + val < 1) throw Bureaucrat::GradeTooLowException();
	this->grade += val;
}
