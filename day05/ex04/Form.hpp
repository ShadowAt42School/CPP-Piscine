...
/*   Updated: 2018/07/03 20:27:44 by maghayev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	class FormSignatureRequired : public std::exception {
		public:
			virtual const char *what() const throw() {
				return "FormSignatureRequired: Form has to be signed before executing\n";
			}
	};
};
