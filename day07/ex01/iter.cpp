...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/07/04 21:28:22 by maghayev          #+#    #+#             */
/*   Updated: 2018/07/05 22:51:02 by maghayev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename T>
void print(T data) {	std::cout << data << std::endl;	}
...
int main( void )
{
	std::string	test[] = {	"TEST", "TESTTEST", "TESTTESTTEST", "sd.nf2kjc"	};

	char	test2[] = {	'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M'	};

	int 	test3[] = {	1, 12, 123, 1234, 12345, 123456, 1234567, 12345678, 123456789, 1234567890	};

	double 	test4[] = {	1.00, 1.20, 12.30, 12.34, 123.45, 1234.56, 12345.67, 123456.78, 1234567.89, 12345678.90	};
